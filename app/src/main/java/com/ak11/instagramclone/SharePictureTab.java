            ...
            case R.id.btnShareImage:
                if(receivedImageBitmap != null){
                    if(edtDescription.getText().toString().isEmpty()){
                        ...
                        FancyToast.makeText(getContext(),"Error : You must specify a caption",FancyToast.LENGTH_SHORT,
                    ...
                    else
                    {
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                if(e==null)
                                    FancyToast.makeText(getContext(),"Done!!!",FancyToast.LENGTH_SHORT,
                    ...
                    FancyToast.makeText(getContext(),"Error : You must select an image",FancyToast.LENGTH_SHORT,
                            FancyToast.ERROR,false).show();
                }
